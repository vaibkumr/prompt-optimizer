...
class NameReplaceOptim(PromptOptimize):
    ...
    def get_opti_names(self):
        opti_names = "Rene Asa Zion Avery Gray Morgan Story Arden Kit Lux Sol Avery Pat Sky Arden Clair Storm Ellery Arin Sol Alpha Arie Rio Isa Aris Ara Adel Tam Lin Aly Bao Tru True Toy Adi Cache Chi Han Amil Amel Eri Truth Hoa Indy Vertis Chai Ottie Ary Aki Rei Bay Ova Shell Rael Gal Sher Elim Dae Zell Wen Audi"
        opti_names = opti_names.split()
        return opti_names       
