...
### LogiQA
[LogiQA](https://github.com/openai/evals/pull/470): A Challenge Dataset for Machine Reading Comprehension with Logical Reasoning
We use the first 100 samples for LogiQA eval to generate the follownig results:
